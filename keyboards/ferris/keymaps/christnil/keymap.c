...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  LT(RAISE_LAYER, KC_A),  LCTL_T(KC_R), LALT_T(KC_S), LGUI_T(KC_T), KC_G,
  ...
  LSFT_T(KC_TAB), LCTL_T(KC_EQL), LALT_T(KC_GRV), LGUI_T(KC_QUOT), KC_DQUO,
                                                                                  KC_BSLS, KC_LCBR, KC_RCBR, KC_PIPE, RSFT_T(KC_ENT),
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  [RAISE_LAYER] = LAYOUT(
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  KC_ESCAPE, KC_AT,   KC_UP,   KC_DLR,   KC_PERC,
                                                                  KC_CIRC, KC_AMPR, KC_ASTR, KC_SCLN, KC_BSPC,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  KC_TRNS,   KC_LEFT, KC_DOWN, KC_RIGHT, KC_DQUO,
                                                                  KC_BSLS, KC_LCBR, KC_RCBR, KC_PIPE, KC_ENT,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  KC_TILD,   KC_EXLM, KC_QUES, KC_UNDS,  KC_MINS,
                                                                  KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_COLN,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
                         MEH_T(KC_SPC),  KC_LGUI,
                                                                  KC_RALT, KC_RCTL
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  )
};
