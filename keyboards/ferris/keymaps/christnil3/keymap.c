...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NAVIGATION_LAYER] = LAYOUT_split_3x5_2(
    KC_ESC,  KC_TRNS, KC_HOME, KC_UP,   KC_END,  KC_TRNS, LCTL(KC_LEFT), LCTL(KC_UP),   LCTL(KC_RGHT), KC_BSPC,
    KC_TAB,  KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_LEFT, KC_DOWN,       KC_UP,   KC_RGHT,       KC_ENT,
    KC_TRNS, KC_TRNS, KC_INS,  KC_PGUP, KC_PGDN, LALT(KC_LEFT), LALT(KC_DOWN), LALT(KC_RGHT), KC_TRNS, KC_DEL,
